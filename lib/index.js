...
exports.app_react = function(widgetName, props, React, ReactWidget, reply){
  ...
  var view = {
    ...
    realFunction: camelCase(widgetName),
    props: JSON.stringify(props),
    script_src: props.asset_url + '/bundle.js',
    stylesheet_src: props.asset_url + '/bundle.css',
  }

  view.widget = React.renderToString(ReactWidget(props));
  if (props.shortcut_src) {
    view.shortcut_src = props.shortcut_src;
  }
  var html = Mustache.render(app_html, view);
